{assign var=min_order_state value=$okaycms_min_order_warning_state|default:$okaycms_min_order_state|default:null}
...
<div class="min-order-warning fn_min_order_warning" data-min-order-blocked="{if $is_blocked}1{else}0{/if}"
     data-min-order-hash="{$min_order_state.hash|default:''|escape}" {if !$is_blocked}style="display:none;"{/if}>
